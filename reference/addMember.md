...
- mo:
  ...
  with the science object. If this DataObject has already been added to
  the package, the argument can be a `"character"` containing the
...
that is being added. The `addMember` function will add a relationship to
